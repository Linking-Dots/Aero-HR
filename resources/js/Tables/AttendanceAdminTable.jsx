...
import { Tooltip as HeroTooltip } from "@heroui/react"; // Make sure Tooltip is imported
                            ...
                            {(data) => (
                                ...
                                {(columnKey) => {
                                    ...
                                    default:
                                        ...
                                        return (
                                            <TableCell className={`text-center ${isWeekend ? 'bg-default-50' : ''}`}>
                                                <HeroTooltip
                                                content={
                                                ...
                                                className="z-[99999]"
                                                >
                                                <Box className="flex items-center justify-center cursor-help">
                                                    {statusInfo.icon ? (
