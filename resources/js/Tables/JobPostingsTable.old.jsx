...
const JobPostingsTable = ({ data = [], loading = false, permissions = [], onView, onEdit, onDelete, onApplications }) => {
    ...
    const renderCell = (item, columnKey) => {
        switch (columnKey) {
            ...
            case "posted_date":
                return item.posted_date ? dayjs(item.posted_date).format('MMM DD, YYYY') : 'N/A';
            case "closing_date":
                return item.closing_date ? dayjs(item.closing_date).format('MMM DD, YYYY') : 'N/A';
            case "applications":
                return (
