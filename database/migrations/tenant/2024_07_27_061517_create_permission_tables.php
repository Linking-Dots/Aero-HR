...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Clear cache (safely handle if cache table doesn't exist)
        try {
            app()[\Spatie\Permission\PermissionRegistrar::class]->forgetCachedPermissions();
        } catch (Exception $e) {
            // Cache table may not exist during initial migration - this is okay
        }
    }
    ...
    public function down(): void
    {
        ...
        try {
            ...
            // Cache table may not exist - this is okay
        }
    }
};
