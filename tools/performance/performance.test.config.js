  ...
  async measureWebVitals(page) {
    return await page.evaluate(() => {
      return new Promise((resolve) => {
        ...
        if (window.webVitals) {
          Promise.all([
            new Promise(res => window.webVitals.getFCP(res)),
            new Promise(res => window.webVitals.getLCP(res)),
            new Promise(res => window.webVitals.getFID(res)),
            new Promise(res => window.webVitals.getCLS(res)),
            new Promise(res => window.webVitals.getTTFB(res))
          ]).then(results => {
            vitals.FCP = results[0];
            vitals.LCP = results[1];
            vitals.FID = results[2];
            vitals.CLS = results[3];
            vitals.TTFB = results[4];
            resolve(vitals);
          });
        } else {
