...
class LeaveController extends Controller
{
    public function index(): \Inertia\Response
    {
        ...
        foreach ($leaveTypes as $type => $leaveType) {
            $totalDaysAvailable = $leaveType->days; // Assuming 'total_days' is the field in leave_types table
            $daysUsed = isset($leaveCounts[$type]) ? $leaveCounts[$type] : 0; // Get the days used, default to 0 if not set
